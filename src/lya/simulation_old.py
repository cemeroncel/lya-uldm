...
class LyaSimulation:
    ...
    def read_gadget(self):
        ...
        self.gadget = {
            ...
            'HeliumHeatOn': c.getint('HeliumHeatOn', 0),
            'HeliumHeatThresh': c.getfloat('HeliumHeatThresh', 10.),
            'HeliumHeatAmp': c.getfloat('HeliumHeatAmp', 1.),
            'HeliumHeatExp': c.getfloat('HeliumHeatExp', 0.),
            # Star formation model parameters
            'QuickLymanAlphaProbability': c.getint('QuickLymanAlphaProbability', 1),
            'CritOverDensity'
        }
